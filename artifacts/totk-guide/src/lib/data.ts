...
export const ARMOR: ArmorSet[] = [
  {
    ...
    effect: "None",
    setBonus: "None",
    upgradeBonus: "Increases base defense each tier",
    pieces: [
      { name: "Hylian Hood",     defense: 3, location: "Lookout Landing shop (70 rupees)",    coords: "-0157, -0012, 0017" },
      { name: "Hylian Tunic",    defense: 3, location: "Lookout Landing shop (130 rupees)",   coords: "-0157, -0012, 0017" },
      { name: "Hylian Trousers", defense: 3, location: "Lookout Landing shop (70 rupees)",    coords: "-0157, -0012, 0017" },
    ],
  },
  {
    id: "archaic",
    name: "Archaic Set",
    effect: "None — outfit worn at game start",
    setBonus: "None",
    upgradeBonus: "Cannot be upgraded",
    pieces: [
      { name: "Archaic Tunic",    defense: 1, location: "Worn at game start on Great Sky Island",  coords: "0274, -0913, 1460" },
      { name: "Archaic Legwear",  defense: 1, location: "Worn at game start on Great Sky Island",  coords: "0274, -0913, 1460" },
    ],
  },
  {
    id: "snowquill",
    ...
    upgradeBonus: "Tier 2 grants Unfreezable set bonus",
    pieces: [
      { name: "Snowquill Headdress", defense: 3, location: "Rito Village — Nekk's shop (500 rupees)",   coords: "-3608, 1843, 0232" },
      { name: "Snowquill Tunic",     defense: 3, location: "Rito Village — Nekk's shop (600 rupees)",   coords: "-3608, 1843, 0232" },
      { name: "Snowquill Trousers",  defense: 3, location: "Rito Village — Nekk's shop (500 rupees)",   coords: "-3608, 1843, 0232" },
    ],
  },
  {
    id: "flamebreaker",
    ...
    effect: "Flame Guard",
    setBonus: "Fireproof",
    upgradeBonus: "Tier 2 grants Fireproof set bonus",
    pieces: [
      { name: "Flamebreaker Helm",  defense: 3, location: "Goron City — Ravio's Shop (600 rupees)",     coords: "1638, 2460, 0382" },
      { name: "Flamebreaker Armor", defense: 5, location: "Goron City — Ravio's Shop (700 rupees)",     coords: "1638, 2460, 0382" },
      { name: "Flamebreaker Boots", defense: 3, location: "Goron City — Ravio's Shop (600 rupees)",     coords: "1638, 2460, 0382" },
    ],
  },
  {
    id: "desert-voe",
    ...
    upgradeBonus: "Tier 2 adds Shock Resistance set bonus",
    pieces: [
      { name: "Desert Voe Headband",  defense: 3, location: "Gerudo Town — Saula's shop, male entrance (450 rupees)", coords: "-3731, -2920, 0015" },
      { name: "Desert Voe Spaulder",  defense: 5, location: "Gerudo Town — Saula's shop, male entrance (1000 rupees)", coords: "-3731, -2920, 0015" },
      { name: "Desert Voe Trousers",  defense: 3, location: "Gerudo Town — Saula's shop, male entrance (450 rupees)", coords: "-3731, -2920, 0015" },
    ],
  },
  {
    id: "zora",
    ...
    setBonus: "Waterfall Climb",
    upgradeBonus: "Tier 2 grants Waterfall Climb set bonus",
    pieces: [
      { name: "Zora Helm",    defense: 3, location: "Toto Lake underwater chest (Sidon's questline)",   coords: "3476, 0520, 0088" },
      { name: "Zora Armor",   defense: 3, location: "Zora's Domain — reward from King Dorephan quest", coords: "3289, 0600, 0270" },
      { name: "Zora Greaves", defense: 3, location: "Zora's Domain — chest in Mipha's Court (sky)",    coords: "3614, 0736, 1065" },
    ],
  },
  {
    id: "rubber",
    ...
    upgradeBonus: "Tier 2 grants Unshockable set bonus",
    pieces: [
      { name: "Rubber Helm",  defense: 3, location: "Lanayru Sky Island puzzle chest (strike 4 lightning towers)", coords: "3480, 0664, 1325" },
      { name: "Rubber Armor", defense: 3, location: "Cave puzzle: Whistling Hill cave chest",                      coords: "-0915, -0175, 0043" },
      { name: "Rubber Tights", defense: 3, location: "Lakeside Stable cave puzzle chest",                          coords: "1720, -3490, 0055" },
    ],
  },
  {
    id: "climbing",
    ...
    setBonus: "Climber's Stamina (sprint-jump while climbing)",
    upgradeBonus: "Tier 2 grants sprint-jump climbing bonus",
    pieces: [
      { name: "Climbing Bandana", defense: 3, location: "Ploymus Mountain cave chest",           coords: "3561, 0765, 0392" },
      { name: "Climbing Gear",    defense: 3, location: "Upland Lindor cave chest",              coords: "-1574, 1336, 0272" },
      { name: "Climbing Boots",   defense: 3, location: "Trilby Valley cave chest",              coords: "-1572, -0099, 0172" },
    ],
  },
  {
    id: "barbarian",
    ...
    upgradeBonus: "Tier 2 grants Charge Attack Stamina Up",
    pieces: [
      { name: "Barbarian Helm",      defense: 3, location: "Crenel Hills cave (through false wall puzzle)", coords: "-0148, 1250, 0148" },
      { name: "Barbarian Armor",     defense: 3, location: "Dracozu Lake shrine ruins cave chest",          coords: "1548, -2630, 0025" },
      { name: "Barbarian Leg Wraps", defense: 3, location: "Robred Dropoff cave chest — East Faron",        coords: "1830, -2970, 0025" },
    ],
  },
  {
    id: "stealth",
    ...
    upgradeBonus: "Tier 2 grants Night Speed Up set bonus",
    pieces: [
      { name: "Stealth Mask",    defense: 3, location: "Kakariko Village cave chest — behind the store", coords: "1816, -1030, 0116" },
      { name: "Stealth Chest Guard", defense: 3, location: "Kakariko Village shop (Enchanted, 500 rupees)", coords: "1816, -1030, 0116" },
      { name: "Stealth Tights",  defense: 3, location: "Kakariko Village shop (Enchanted, 400 rupees)",  coords: "1816, -1030, 0116" },
    ],
  },
  {
    id: "soldiers",
    ...
    effect: "None",
    setBonus: "None",
    upgradeBonus: "High defense per tier",
    pieces: [
      { name: "Soldier's Helm",   defense: 5, location: "Hyrule Castle grounds — chest near Lockup entrance",  coords: "-0536, 0806, 0090" },
      { name: "Soldier's Armor",  defense: 5, location: "Hyrule Castle West tower chest",                      coords: "-0765, 0993, 0108" },
      { name: "Soldier's Greaves", defense: 5, location: "Hyrule Castle East courtyard chest",                  coords: "0015, 1094, 0098" },
    ],
  },
  {
    id: "depths-armor",
    name: "Armor of the Depths",
    effect: "Gloom Resistance",
    setBonus: "Gloom HP restored by sleeping at campfire",
    upgradeBonus: "Tier 2 grants Gloom Resistance bonus",
    pieces: [
      { name: "Hood of the Depths",    defense: 5, location: "Bargainer Statue — Hyrule Castle Depths (200 Poes)", coords: "-0195, 0830, -0600" },
      { name: "Tunic of the Depths",   defense: 5, location: "Bargainer Statue — Hyrule Castle Depths (300 Poes)", coords: "-0195, 0830, -0600" },
      { name: "Gaiters of the Depths", defense: 5, location: "Bargainer Statue — Hyrule Castle Depths (200 Poes)", coords: "-0195, 0830, -0600" },
    ],
  },
  {
    id: "phantom",
    name: "Phantom Set",
    effect: "Guardian Resist Up",
    setBonus: "Guardian Resist Up++ (stacks)",
    upgradeBonus: "Improves Guardian Resist Up per tier",
    pieces: [
      { name: "Phantom Helm",    defense: 8, location: "Bargainer Statue — Wellspring of Power area, Depths (150 Poes)", coords: "2358, 2544, -0600" },
      { name: "Phantom Armor",   defense: 8, location: "Bargainer Statue — Wellspring of Courage Depths (150 Poes)",     coords: "0818, -2536, -0600" },
      { name: "Phantom Greaves", defense: 8, location: "Bargainer Statue — Wellspring of Wisdom Depths (150 Poes)",      coords: "3400, 0512, -0600" },
    ],
  },
  {
    id: "evil-spirit",
    name: "Evil Spirit Set",
    effect: "Bone Attack Up",
    setBonus: "Bone Atk Up++ (stacks)",
    upgradeBonus: "Improves Bone Atk Up per tier",
    pieces: [
      { name: "Evil Spirit Mask",  defense: 5, location: "North Lomei Labyrinth — sky island chest (above Akkala)", coords: "4441, 3688, 0720" },
      { name: "Evil Spirit Armor", defense: 5, location: "South Lomei Labyrinth — depths level solution chest",     coords: "-4504, -3632, -0520" },
      { name: "Evil Spirit Greaves", defense: 5, location: "Lomei Labyrinth Island — Southeast Necluda Sea chest",  coords: "4776, -3427, 0025" },
    ],
  },
  {
    id: "fierce-deity",
    ...
    effect: "Attack Up",
    setBonus: "Attack Up++ (stacks)",
    upgradeBonus: "Improves Attack Up per tier",
    pieces: [
      { name: "Fierce Deity Mask",  defense: 5, location: "Akkala cave — Misko's Cave of Treasures I (chest marked by sign)", coords: "3997, 1631, 0103" },
      { name: "Fierce Deity Armor", defense: 5, location: "Lanayru cave — Misko's Cave of Treasures II",                      coords: "3480, 0664, 0050" },
      { name: "Fierce Deity Boots", defense: 5, location: "Necluda cave — Misko's Cave of Treasures III",                     coords: "2228, -2524, 0025" },
    ],
  },
  {
    id: "ancient-hero",
    name: "Ancient Hero's Aspect",
    effect: "Disguises Link as an ancient hero; glows green",
    setBonus: "None (cosmetic transformation)",
    upgradeBonus: "Cannot be upgraded",
    pieces: [
      { name: "Ancient Hero's Aspect", defense: 0, location: "Complete all 152 shrines — reward chest at Temple of Time (Great Sky Island)", coords: "0388, -1660, 2299" },
    ],
  },
  {
    id: "sand-boots",
    name: "Sand & Snow Boots",
    effect: "Move at full speed on sand / snow",
    setBonus: "None (individual items)",
    upgradeBonus: "Defense improves per tier",
    pieces: [
      { name: "Sand Boots", defense: 3, location: "South Akkala Stable secret stone merchant (300 rupees)",  coords: "3792, 1626, 0109" },
      { name: "Snow Boots", defense: 3, location: "Rito Stable secret stone merchant (300 rupees)",         coords: "-3462, 1519, 0219" },
    ],
  },
  {
    id: "glide",
    name: "Glide Set",
    effect: "Skydiving speed and maneuvering",
    setBonus: "Skydive Mobility Up",
    upgradeBonus: "Tier 2 grants Skydive Mobility Up",
    pieces: [
      { name: "Glide Mask",  defense: 3, location: "Sky Island near Wind Temple — chest at top of the sky fortress", coords: "-2360, 2540, 1200" },
      { name: "Glide Shirt", defense: 3, location: "Sky Island puzzle area — chest near Valor Island",               coords: "2832, -1880, 1250" },
      { name: "Glide Tights", defense: 3, location: "Sky Island near Gerudo — Starview Island chest",                coords: "-4020, 0810, 1290" },
    ],
  },
  {
    id: "zonaite",
    name: "Zonaite Set",
    effect: "Charge your Energy Cell faster",
    setBonus: "Faster Energy Cell recharge",
    upgradeBonus: "Further charge rate per tier",
    pieces: [
      { name: "Zonaite Helm",   defense: 3, location: "Sky Island — Construct Barracks chest (Great Sky Island area)", coords: "0480, -1560, 1408" },
      { name: "Zonaite Waistguard", defense: 3, location: "Sky Island — South Hyrule Sky Archipelago large chest",      coords: "0200, -1400, 1462" },
      { name: "Zonaite Shin Guards", defense: 3, location: "Sky Island — large island south of Great Sky Island",        coords: "0120, -1100, 1462" },
    ],
  },
];
